...
class BoardsTest < ApplicationSystemTestCase
  ...
  test "should create board" do
    ...
    fill_in "Keycaps", with: @board.keycaps
    fill_in "Kit", with: @board.kit
    fill_in "Layout", with: @board.layout
    fill_in "Layout", with: @board.layout_id
    fill_in "Price", with: @board.price
    fill_in "Stabilizers", with: @board.stabilizers
    fill_in "Switches", with: @board.switches
